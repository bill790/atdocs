...
所有的 I/O PIN脚设计成能在电压范围在 0V and V<sub>CC</sub>之间安全工作。连任何PIN到一个高于元件供电电压很可能会损害到该PIN脚。总是验证你的传感器和变能器产生的电压能匹配跟它们连的 I/O PIN脚。为了连不同供电的设备到一起, 用[电平转换器](https://www.sparkfun.com/products/12009) 电路。
